 ...
 * v1.2.3b	31 dec	2005	Jean-S閎astien Goupil	Just one barcode.bak per drawing
 * v1.2.1	27 jun	2005	Jean-S閎astien Goupil	Font support added
 * V1.00	17 jun	2004	Jean-Sebastien Goupil
 *--------------------------------------------------------------------
 * $Id: DrawingBarCode.class.php,v 1.11 2009/03/23 06:48:30 jsgoupil Exp $
 *--------------------------------------------------------------------
...
class DrawingBarCode {
	...
	/**
	 * Draw the barcode.bak on the image $im
	 */
