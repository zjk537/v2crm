 ...
 *--------------------------------------------------------------------
 * Revision History
 * v2.0.1	8  mar	2009	Jean-S閎astien Goupil	Fix Code 128 C
 * v2.00	23 apr	2008	Jean-S閎astien Goupil	New Version Update
 * v1.2.3pl2	27 sep	2006	Jean-S閎astien Goupil	There were some errors dealing with C table
 * v1.2.3b	30 dec	2005	Jean-S閎astien Goupil	Checksum separated + PHP5.1 compatible
 * v1.2.1	27 jun	2005	Jean-S閎astien Goupil	Font support added + Correct bug if passing C to another code
 * V1.00	17 jun	2004	Jean-Sebastien Goupil
 *--------------------------------------------------------------------
 * $Id: Code128BarCode.class.php,v 1.16 2009/03/23 06:48:30 jsgoupil Exp $
 *--------------------------------------------------------------------
...
class Code128BarCode extends Barcode1DBarCode {
	const KEYA_FNC3 = 96;
	const KEYA_FNC2 = 97;
	const KEYA_SHIFT = 98;
	const KEYA_CODEC = 99;
	...
	/**
	 * Returns the maximal size of a barcode.bak
	 *
	 * @return int[]
	 */
