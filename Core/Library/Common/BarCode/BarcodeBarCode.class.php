 ...
 *--------------------------------------------------------------------
 * $Id: BarcodeBarCode.class.php,v 1.12 2009/05/03 20:49:40 jsgoupil Exp $
 *--------------------------------------------------------------------
...
abstract class BarcodeBarCode
{
    ...
    /**
     * Sets the foreground color of the barcode.bak. It could be a BCGColor
     * value or simply a language code (white, black, yellow...) or hex value.
     * @param mixed $code
     */
    public function setForegroundColor($code)
    {
        if($code instanceof ColorBarCode) {
            $this->colorFg = $code;
        } else {
            $this->colorFg = new ColorBarCode($code);
        }
    }

    /**
     * Sets the background color of the barcode.bak. It could be a BCGColor
     * value or simply a language code (white, black, yellow...) or hex value.
     * @param mixed $code
     */
    public function setBackgroundColor($code)
    {
        if($code instanceof ColorBarCode) {
            ...
            $this->colorBg = new ColorBarCode($code);
        }
    }
